            ...
            <div class="col-md-6">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="owner_name"required id="owner_name" class="form-control form-control-border" placeholder="John D Smith" value ="<?php echo isset($owner_name) ? $owner_name : '' ?>" required>
                    </div>
                    <div class="form-group">
...
<body>
    ...
    <button onclick="showPopup()">View Terms and Conditions</button>

    <!-- Popup content -->
    <div id="popup" class="popup-overlay" style="display: none;">
        <div class="popup-container">
            <h1>Terms and Conditions</h1>
            <p>Welcome to our website. By using our website, you agree to comply with and be bound by the following terms and conditions:</p>
            <p>1. Appointment Booking: By submitting the veterinary clinic appointment form, 
                you acknowledge and agree that you are booking an appointment for your pet 
                at the designated veterinary clinic. The appointment is subject to availability 
                and confirmation by the veterinary clinic.</p>
